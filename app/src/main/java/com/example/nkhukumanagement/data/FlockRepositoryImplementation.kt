...
class FlockRepositoryImplementation @Inject constructor(private val flockDao: FlockDao) : FlockRepository {
    ...
    override fun getFlockWithIncome(id: Int): Flow<FlockWithIncome> = flockDao.getFlocksWithIncome(id)

    override fun getFlockWithExpenses(id: Int): Flow<FlockWithExpenses> = flockDao.getFlocksWithExpense(id)
    override fun getAccountsWithIncome(id: Int): Flow<AccountsWithIncome> = flockDao.getAccountsWithIncome(id)

    override fun getAccountsWithExpense(id: Int): Flow<AccountsWithExpense> = flockDao.getAccountsWithExpense(id)

    override suspend fun insertFlock(flock: Flock) = flockDao.insertFlock(flock)
    override suspend fun insertAccounts(accountsSummary: AccountsSummary) = flockDao.insertAccounts(accountsSummary)
    ...
    override suspend fun deleteAccounts(flockUniqueID: String) = flockDao.deleteAccounts(flockUniqueID)
    ...
    override suspend fun updateAccounts(accountsSummary: AccountsSummary) = flockDao.updateAccounts(accountsSummary)
