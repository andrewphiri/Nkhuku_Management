...
class FlockRepositoryImplementation @Inject constructor(private val flockDao: FlockDao) : FlockRepository {
    ...
    override fun getAllFlocksWithVaccinations(): Flow<List<FlockWithVaccinations>> = flockDao.getFlocksWithVaccinations()
    ...
    override suspend fun deleteFlock(flock: Flock) = flockDao.deleteFlock(flock)
    override suspend fun deleteVaccination(vaccination: Vaccination) = flockDao.deleteVaccination(vaccination)
